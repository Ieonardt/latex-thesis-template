...
% USE ONLY WHEN NOT COMPILED WITH XELATEX
%%%
...
% package for quotes, quote mark style is set depending on the default babel language
\usepackage{csquotes}
...
% set the style of the bibliography to apa7
...
% Allow todos
\usepackage[color=note]{todonotes}
