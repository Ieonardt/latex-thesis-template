...
\begin{compactitem}
  \item ein Beitrag in einer Zeitschrift \parencite{MopOverview},
  \item ein Beitrag in einem Sammlungsband \parencite{moore},
  \item ein Buch \parencite{scala},
  \item ein Beitrag im Berichtsband einer Konferenz \parencite{rltl},
  \item ein technischer Bericht \parencite{bitkom},
  \item eine Dissertation \parencite{Leucker02},
  \item eine Abschlussarbeit \parencite{RltlConv},
  \item ein (noch) nicht veröffentlichter Artikel \parencite{ptLTL} oder
  \item ein Artikel auf einer Website \parencite{codecommit} sein.
\end{compactitem}

Quellen können im Text auf zwei Arten zitiert werden. Einerseits können sie als bloßer Vermerk hinter eine Textpassage gestellt werden, um klar zu machen auf welche
Veröffentlichung sich bezogen wird \parencite{MopOverview}. Andererseits ist es auch möglich die Quelle direkt in den Satz einzubauen in dem man schreibt: 
\enquote{Wie bereits von \textcite{Leucker02} beschrieben ...}.
...
\begin{figure}
  \centering
  \pgfimage[width=.5\textwidth]{images/flower}
